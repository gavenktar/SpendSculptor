...
public class ReceiptController {
    ...
    @Autowired
    public ReceiptController(ReceiptService receiptService, CategoryService categoryService, AccountUserService accountUserService, PositionService positionService, Util util) {
